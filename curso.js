function cargarContenidoCurso() {
    ...
    cursoContainer.innerHTML = `
        ...
        <ul>
            <li>Programación Orientada a Objetos (POO)
                <p>
                    ...
                    <img src="https://s3.us-east-2.amazonaws.com/mgpanel/619-poo-mgpanel2.jpg" alt="Concepto de POO" class="inline-image">
                </p>
                <p>
            ...
            <li>C++
                <p>
                    ...
                    <img src="https://phoenixnap.com/glossary/wp-content/uploads/2022/12/object-oriented-programming-explained.jpg" alt="Ejemplo de C++" class="inline-image">
                </p>
                <p>
            ...
            <li>Java (Interfaces Visuales)
                <p>
                    ...
                    <img src="https://img-c.udemycdn.com/course/750x422/3820290_4cfe.jpg" alt="Interfaz en Java" class="inline-image">
                </p>
                <p>
        ...
        <p>
            ...
            <a href="https://profile.es/blog/que-es-la-programacion-orientada-a-objetos/" target="_blank">¿Qué es la Programación Orientada a Objetos?</a>
        </p>
        <p>
        ...
        <iframe 
            width="560" 
            height="315" 
            src="https://www.youtube.com/embed/8ZS-Te8aBWM" 
